 ...
 */
define("HOST", "db599644848.db.1and1.com"); 			// The host you want to connect to. 
define("USER", "dbo599644848"); 			// The database username. 
define("PASSWORD", "Media.Database"); 	// The database password. 
define("DATABASE", "db599644848");             // The database name.
